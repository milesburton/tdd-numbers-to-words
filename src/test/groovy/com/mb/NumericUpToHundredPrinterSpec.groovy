...
class NumericUpToHundredPrinterSpec extends Specification {

	NumericUpToHundredAsWordPrinter humanNumberPrinter

	void setup() {
		humanNumberPrinter = new NumericUpToHundredAsWordPrinter()
	}
